...
public class ModificacionCorrectaTest {
	...
	public void modificacionCorrecta() {
		...
		driver.findElement(By.name("taskName")).sendKeys("Primer test");
		driver.findElement(By.cssSelector(".btn-success")).click();
		driver.findElement(By.cssSelector(".btn-primary")).click();
		vars.put("variable", driver.findElement(By.cssSelector(".container")).getText());
		System.out.println(vars.get("variable").toString());
	}
}
